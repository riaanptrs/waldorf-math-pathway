(() => {
  ...
  const earlyLessons = [
    ...
    },
    {
      ...
      sourceFocus: "Original Grade 4 fraction introduction through repeated equal sharing with varied, non-circular wholes.", teacherAim: "Learners understand what a fraction means and notice that more equal parts means each part is smaller.",
      visualModel: [{ parts: 4, shaded: 1, label: "1/4" }, { parts: 8, shaded: 1, label: "1/8" }],
      memoryRefresh: { idea: "A fraction names equal parts of a chosen whole; the whole must be clear before its parts can be named.", method: ["Choose and name the whole.", "Share it into equal parts using an object, strip, collection, or length.", "Count all equal parts for the denominator.", "Count chosen parts for the numerator."], example: "One chosen section of a ribbon divided into eight equal lengths is 1/8 of that ribbon." },
  ...
  const pt = {
    ...
    "g4-fraction-branches": { block: "Início das Frações", title: "Um Inteiro, Partes Menores", prompt: "Um pão é dividido igualmente entre 8 crianças. Que fração cada uma recebe?", correction: "Oito partes iguais formam o inteiro; cada criança recebe 1/8.", memoryRefresh: { idea: "Uma fração nomeia partes iguais de um inteiro escolhido; precisamos saber qual é o inteiro antes de nomear suas partes.", method: ["Escolha e nomeie o inteiro.", "Divida-o em partes iguais usando um objeto, uma tira, uma coleção ou um comprimento.", "Conte todas as partes para encontrar o denominador.", "Conte as partes escolhidas para encontrar o numerador."], example: "Uma seção escolhida de uma fita dividida em oito comprimentos iguais é 1/8 da fita." }, rhythm: ["Primeiro, um inteiro.", "Faça partes iguais.", "Diga quantas partes formam o inteiro."] },
